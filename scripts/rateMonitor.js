...
function setupDataStore(){
    ...
    dataStore.ODBrequests = ['http://grsmid00.triumf.ca:8081/?cmd=jcopy&odb0=/Equipment/Epics/Variables/MSRD&odb1=/Runinfo/Run number&encoding=json-p-nokeys&callback=parseScalars'];
    dataStore.scalars = {
            'PC': 0,
            'LF1': 0,
            'LF2': 0
            ...
            'levels':[
                {
                    ...
                    'lvlID': 'PC'                  //target plot identifier
                },
                {
                    'title': 'Laser Freq. 1',
                    'lvlID': 'LF1'
