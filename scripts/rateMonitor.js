...
function setupDataStore(){
    ...
    dataStore.Y1AxisMinValue = [0,1E-8,0,-4500,0,0];               //default Y axis limits - Min value for Y1 axis
    dataStore.Y1AxisMaxValue = [100,1E-6,105,4500,1000,1000];     //default Y axis limits - Max value for Y1 axis
    dataStore.Y2AxisMinValue = [750,0,0,-4500,0,0];                //default Y axis limits - Min value for Y2 axis
    dataStore.Y2AxisMaxValue = [950,35,50,4500,1000,10000];      //default Y axis limits - Max value for Y2 axis
    dataStore.defaults = [];
