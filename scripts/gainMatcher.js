...
function setupDataStore(){
    ...
    dataStore.spectrumServer = 'http://grifstore0.triumf.ca:9093/';           //host + port of analyzer server
    dataStore.ODBhost = 'http://grifstore0.triumf.ca:8081/';                  //MIDAS / ODB host + port
